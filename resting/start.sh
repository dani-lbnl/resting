...
mv conf.py conf.py.original
echo -e "import os\nimport sys\nsys.path.append(os.path.abspath('../../resting'))\nautodoc_mock_imports=['urllib','urllib.request','json','ssl','project','csv','re']\n" > conf.py
cat conf.py.original >> conf.py
echo -c "extensions.append('sphinx.ext.autodoc')\n" >> conf.py
